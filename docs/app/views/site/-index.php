...
<div class="navs">
    ...
    <div style="margin-bottom: 20px;">
        <?php $this->widget(
            ...
            array('style' => 'tabs', 'stacked' => true, 'items' => $navItems)
        ); ?>
    </div>
    ...
    <div style="margin-bottom: 20px;">
        <?php $this->widget(
            'bootstrap.widgets.TbNav',
            array('style' => 'pills', 'stacked' => true, 'items' => $navItems)
        ); ?>
    </div>
...
<div class="thumbs" style="width: 870px;">
    ...
    <?php $captionThumbnail = array(
        'content' => '<img src="http://placehold.it/300x200" /><div class="caption"><h3>Thumbnail label</h3><p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>' . TbHtml::button(
            'Action',
            array('style' => 'primary')
...
<div class="tooltips">
    ...
    <p class="muted">
        ...
        <?php echo TbHtml::tooltip('twitter handle', '#', 'The last tip!', array('placement' => 'left')); ?> freegan
        cred
    ...
    <?php echo TbHtml::popover(
        'Popover on top',
        'Popover on top',
        'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.',
        array('class' => 'btn', 'placement' => 'top', 'onclick' => 'return false;')
    ); ?>
    <?php echo TbHtml::popover(
        'Popover on right',
        'Popover on right',
        'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.',
        array('class' => 'btn', 'placement' => 'right', 'onclick' => 'return false;')
    ); ?>
    <?php echo TbHtml::popover(
        'Popover on bottom',
        'Popover on bottom',
        'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.',
        array('class' => 'btn', 'placement' => 'bottom', 'onclick' => 'return false;')
    ); ?>
    <?php echo TbHtml::popover(
        'Popover on left',
        'Popover on left',
        'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.',
        array('class' => 'btn', 'placement' => 'left', 'onclick' => 'return false;')
    ); ?>
...
<div class="search-forms">
    ...
    <?php echo $form->row(
        TbHtml::INPUT_RADIOBUTTONLIST,
        $model,
        'radioButton',
        array(),
        array('papa' => 'Superman', '4' => 'test')
    ); ?>

    <?php echo $form->row(
        TbHtml::INPUT_CHECKBOXLIST,
        $model,
        'radioButton',
        array('checkAll' => 'All'),
        array('papa' => 'Superman', '4' => 'test')
    ...
    <div>
        ...
        $this->widget(
            ...
            array(
                ...
                'buttonOptions' => array(
                    'label' => 'show modal with remote content',
...
<div id="tabs">
    <h5>Tabs Left
        <small>Change configuration for testing</small>
    </h5>
    <?php
    $this->widget(
...
<div id="typeahead">
    <h5>Typeahead plugin
        <small>accepts bootstrap options</small>
    </h5>
    <?php
    $this->widget(
        ...
        array(
            ...
            'htmlOptions' => array(
                ...
                'placeholder' => 'Write an USA country'
            ),
            'source'      => array(
                "Alabama",
                "Alaska",
